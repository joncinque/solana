...
impl borsh0_9::de::BorshDeserialize for Pubkey {
    fn deserialize(
        buf: &mut &[u8],
    ) -> ::core::result::Result<Self, borsh0_9::maybestd::io::Error> {
    ...
    [u8; 32]: borsh0_9::BorshSchema,
{
    ...
    fn add_definitions_recursively(
        ...
        let fields = borsh0_9::schema::Fields::UnnamedFields(
            <[_]>::into_vec(
                borsh0_9::maybestd::boxed::Box::new([<[u8; 32] as borsh0_9::BorshSchema>::declaration()]),
            ),
        );
        let definition = borsh0_9::schema::Definition::Struct {
            fields,
        };
        <Self as borsh0_9::BorshSchema>::add_definition(<Self as borsh0_9::BorshSchema>::declaration(), definition, definitions);
